...
void inputOptions(int argc, char *argv[], int *outConn, int *outOrdPar, int *outInterspike, char *ftsync, char  *fphase, char *fpos, char *fvel)
{
    ...
    reorientInteraction = opt_flag(&argc, argv, 1, "--reorientInteraction");  // Reorient upon receiving an interaction 
    reorientFiring = opt_flag(&argc, argv, 1, "--reorientFiring");            // Reorient upon firing
